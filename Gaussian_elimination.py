...
#методом Гаусса.
# В первой строке задаются два числа: количество уравнений n (n ≥ 1)
# и количество неизвестных m (m ≥ 1).
# Далее идут n строк, каждая из которых содержит m+1 число.
# Первые m чисел — это коэффициенты i-го уравнения системы,
# а последнее, (m+1)-е число — коэффициент b, стоящий в правой части i-го уравнения.


# Алгоритм
# 1. прямой проход
# 2. сранвнить ранги матрицы и расширенной матрицы - сравнить кол-во ненулевых строк
# 3. обрезать нулевые строки
# 4. если m > n, то решение бесконечно много
